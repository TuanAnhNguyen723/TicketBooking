        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="category" id="category" required 
                            ...
                            <option value="event" {{ old('category', $event->category) == 'event' ? 'selected' : '' }}>Sự kiện & Lễ hội</option>
                            <option value="attraction" {{ old('category', $event->category) == 'attraction' ? 'selected' : '' }}>Địa điểm du lịch</option>
                        </select>
                        @error('category')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
